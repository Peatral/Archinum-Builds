...
public class BlockFragranceMixer extends BlockBase {

    private final Random random = new Random();

    public BlockFragranceMixer() {
        super(Material.rock);
    }

    public Item getItemDropped(int p_149650_1_, Random random, int p_149650_3_) {
        return Item.getItemFromBlock(ABBlocks.fragranceMixer);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityPlayer, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        if (world.isRemote) {
            ...
            TileEntityFragranceMixer tileEntity = (TileEntityFragranceMixer) world.getTileEntity(x, y, z);

            if (tileEntity != null) {
                entityPlayer.openGui(ArchinumBuilds.instance, 2, world, x, y, z); //TODO: Change id
            }
    ...
    public TileEntity createNewTileEntity(World world, int p_149915_2_) {
        return new TileEntityFragranceMixer();
    }
