...
public class ItemCrystal extends Item{
	...
	public void registerIcons(IIconRegister register)
	{
		...
		{
			icons[i] = register.registerIcon(ArchinumBuilds.MODID + ":" + ResourceOres.values()[i].getName() + "Crystal");
		}
	}
	...
	public String getUnlocalizedName(ItemStack item)
	{
		...
		{
			return "item." + ResourceOres.values()[item.getItemDamage()].getName().toLowerCase() + "Crystal";
		}
