...
public class ItemShard extends Item{
	...
	public void registerIcons(IIconRegister register)
	{
		...
		{
			icons[i] = register.registerIcon(ArchinumBuilds.MODID + ":" + ResourceOres.values()[i].getName() + "Shard");
		}
	}
	...
	public String getUnlocalizedName(ItemStack item)
	{
		...
		{
			return "item." + ResourceOres.values()[item.getItemDamage()].getName().toLowerCase() + "Shard";
		}
