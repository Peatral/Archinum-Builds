...
public class ItemCluster extends Item{
	...
	public void registerIcons(IIconRegister register)
	{
		...
		{
			icons[i] = register.registerIcon(ArchinumBuilds.MODID + ":" + ResourceOres.values()[i].getName() + "Cluster");
		}
	}
	...
	public String getUnlocalizedName(ItemStack item)
	{
		...
		{
			return "item." + ResourceOres.values()[item.getItemDamage()].getName().toLowerCase() + "Cluster";
		}
